...
export const en = {
  ...
  'scanner.notSupportedTitle': 'Camera Not Available',
  'scanner.notSupportedDesc': 'This browser cannot open the camera here. Open the link in Chrome over HTTPS and allow camera access.',
  ...
  'scanner.reading': 'Reading barcode…',
  'scanner.holdStill': 'Hold still',
  'scanner.boxSaved': 'Box {n} saved',
  'scanner.boxCaptured': 'Captured',
  'scanner.scanRejected': 'Rejected',
  'scanner.badRead': 'Misread — scan again',
  'scanner.alreadyScanned': 'Already scanned',
  'scanner.duplicateBadge': 'Duplicate',
  'scanner.captureAnyway': 'Capture anyway',
  'scanner.hardwareTriggerOn': 'Remote on',
  'scanner.captureHint': "Barcode won't scan? Tap anywhere on the camera to capture the label",
  ...
  'components.settings.tapCapture': 'Tap camera to capture',
  'components.settings.hardwareTrigger': 'Remote-control capture',
  ...
  'terminal.barcodeCreateBtn': 'Create a barcode for this carton',
  'terminal.barcodeCreating': 'Creating…',
  'terminal.barcodeMinted': 'Barcode {code} created — print it from Labels',
  'terminal.barcodeMintFailed': "Couldn't create a barcode. Check the connection, or continue without one.",
  'terminal.barcodeNeedName': 'Set the item name first — the sticker has to say what it is',
