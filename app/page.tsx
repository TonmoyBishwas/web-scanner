...
export default function Home() {
  return (
    <div className="min-h-screen bg-canvas text-ink flex items-center justify-center p-6">
      <div className="max-w-md w-full bg-raised border border-line rounded-[14px] p-8 text-center space-y-4 animate-fadeUp">
        ...
        <h1 className="text-2xl font-extrabold">Warehouse Scanner</h1>
        <p className="text-ink-muted">
          This scanner works through your Telegram bot. Please scan the QR code or open the link sent to you on Telegram.
        </p>
        <div className="bg-sunken border border-line rounded-xl p-4 text-sm text-ink-body">
          <p className="eyebrow mb-2">How to use:</p>
          <ol className="text-start space-y-1 list-decimal list-inside">
            <li>Open Telegram</li>
